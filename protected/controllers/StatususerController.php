...
class StatususerController extends Controller {
    ...
    public function actionIndex() {
        ...
        //$dataProvider=new CActiveDataProvider('StatusUser');
    ...
    public function actionAdmin() {
        $model = new StatusUser('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['StatusUser']))
            $model->attributes = $_GET['StatusUser'];
     ...
     * @param StatusUser $model the model to be validated
     */
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'status-user-form') {
