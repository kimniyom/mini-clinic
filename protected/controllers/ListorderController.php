...
class ListorderController extends Controller {
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['Listorder'])) {
            $model->attributes = $_POST['Listorder'];
            if ($model->save())
    ...
    public function actionIndex() {
        $dataProvider = new CActiveDataProvider('Listorder');
    ...
    public function actionAdmin() {
        $model = new Listorder('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Listorder']))
            $model->attributes = $_GET['Listorder'];
     ...
     * @param Listorder $model the model to be validated
     */
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'listorder-form') {
