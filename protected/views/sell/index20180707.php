    ...
    <div class="row" style="margin:0px;">
            ...
            <div class="well well-sm" style="margin-bottom:0px;">
                <div class="row" style="margin:0px;">
                    ...
                    <div class="col-md-6 col-lg-6" style="padding-right:0px;">
                        รายละเอียดสินค้า
                        <div id="detailproduct" class="well well-sm" style="margin:0px; height:155px; background:#333333;"></div>
                    </div>
                </div>
                <div class="row" style="margin:0px;">
        ...
        <div class="col-md-3 col-lg-3" style="padding:0px;">
            <div class="well well-sm" style="margin-bottom:5px;" id="boxrightsell">
                ...
                <div class="well well-sm" style=" text-align: center; background: #333333;">
                    <!--
                ...
                <div class="well well-sm" style=" text-align: center; background: #333333; margin-bottom: 0px;">
                    รับเงิน
...
<script type="text/javascript">
    ...
    function Setscreen() {
        ...
        if (width >= 768) {
            ...
            var boxrightsell = height - 120;//61
