                ...
                <div class="dropdown">
                    ...
                    <?php if ($order['status'] == '0' || $order['status'] == '1') { ?>
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                            <?php if ($order['status'] == '0') { ?>
                                <li><a href="javascript:checkitem()">ยืนยัน</a></li>
                            <?php } ?>
    ...
    <div class="col-md-3 col-lg-3">
        <div class="row">
            ...
            <div class="col-md-5 col-lg-5 col-sm-5 col-xs-5">
                <input type="text" id="distcount" class="form-control" <?php echo $rtextbox ?> placeholder="%" value="<?php echo $order['distcount'] ?>" style=" text-align: center;" onKeyUp="if (isNaN(this.value)) {
