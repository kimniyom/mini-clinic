<script type="text/javascript">
    function chang_address(type, value, active) {
        var url = "<?php echo Yii::app()->createUrl('backend/user/get_combobox') ?>";
    ...
    function edit_address() {
        ...
        var url = "<?php echo Yii::app()->createUrl('backend/user/get_address') ?>";
        var pid = $("#pid").val();
        var data = {pid: pid};
        $.post(url, data, function (result) {
    ...
    function save_address() {
        var url = "<?php echo Yii::app()->createUrl('backend/user/save_address') ?>";
        var name = $("#name").val();
        var lname = $("#lname").val();
