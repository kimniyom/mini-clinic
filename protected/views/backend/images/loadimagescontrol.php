...
<div class="row" style=" margin: 0px;">
    <div id="con-img" style=" padding: 0px; margin: 0px;">
...
<script type="text/javascript">
    function DelImg() {
        ...
        var url = "<?php echo Yii::app()->createUrl('backend/images/deleteimages') ?>";
        var data = {img: imgVal};
...
<script type="text/javascript">
    function DelImgAll() {
        ...
        if (r == true) {
            var url = "<?php echo Yii::app()->createUrl('backend/images/deleteimagesall') ?>";
            var data = {};
            $.post(url, data, function (datas) {
                load_data();
            });
