...
<div class="well well-sm" style="width:100%; margin: 0px; position: relative;">
    <div style="width: 150px; height: 100px; position: absolute; right: 10px; top: 10px; text-align: center; font-size: 18px;">
        คงเหลือ <font id="stock" style="color: yellow;">-</font> <font id="unit"></font>
    </div>
            <div class="row">
                <div class="col-lg-12">
...
$this->widget('booster.widgets.TbSelect2', array(
	...
	'name' => 'product_id',
	'id' => 'product_id',
	'data' => CHtml::listData(ClinicStockproduct::model()->findAll(), 'product_id', 'product_nameclinic'),
	//'value' => $model,
	'options' => array(
		'allowClear' => true,
		//$model,
...
?>
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <input type="text" id="product_text" name="product_text" class="form-control" style="width:40%;" readonly="readonly"/>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-3">
                    <label for="">จำนวนนำเข้า / <label id="unit"></label>*</label>
...
<script type="text/javascript">
    ...
    $("#product_id").change(function(){
        ...
        $.post(url, data, function (datas) {
            console.log(datas);
            $("#product_text").val(datas.product_id);
