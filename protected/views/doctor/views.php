...
<div class="easyui-layout" id="layouts" style=" width: 100%; margin: 0px;">
    ...
    <div data-options="region:'west',split:false" title="เมนู" style="width:300px;position: relative; background:url('<?php echo Yii::app()->baseUrl ?>/images/wave-background.png') top center;">
        <div class="row" style=" margin: 0px;">
        ...
        <div style=" position: absolute; bottom: 0px; width: 100%;">
            <?php $link = Yii::app()->createUrl('service/bill', array("service_id" => $service_id, 'promotion' => 0)); ?>
            <div class="row" style=" margin: 0px;">
    ...
    <div data-options="region:'center',title:'ประวัติการรับบริการ',iconCls:'icon-ok'">
                            ...
                            <tr>
                                <th colspan="4">
                                    ...
                                    <ul style="list-style: none;">
                                        <li><?php echo ($service['payment'] == "1") ? "<i class='fa fa-check'></i>" : "<i class='fa fa-remove'></i>"; ?> เงินสด</li>
                                        <li><?php echo ($service['payment'] == "2") ? "<i class='fa fa-check'></i>" : "<i class='fa fa-remove'></i>"; ?> เงินโอน</li>
                                    </ul>
                                </th>
                            </tr>
                        </tfoot>
