                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-6 col-xs-6" style=" margin-bottom: 20px;">
                            <a href="<?php echo Yii::app()->createUrl('backend/stock/expireproduct') ?>">
                                <span class="badge" style=" position: absolute;top:0px; left: 10px; background: <?php echo ($alet->Countalertproduct(Yii::app()->session['branch']) > 0) ? "#000000;" : "#111111;"; ?>">
                                    <?php echo $alet->Countalertproduct(Yii::app()->session['branch']); ?>
                                </span>
                                <div class="<?php echo ($alet->Countalertproduct(Yii::app()->session['branch']) > 0) ? "btn btn-danger" : "btn btn-default"; ?> btn-block">
                        ...
                        <div class="col-md-6 col-lg-6 col-xs-6" style=" margin-bottom: 20px;">
                            <a href="<?php echo Yii::app()->createUrl('backend/stock/expireitem') ?>">
                                <span class="badge" style=" position: absolute;top:0px; left: 10px; background: <?php echo ($alet->CountAlertExpire() > 0) ? "#000000;" : "#111111;"; ?>">
                                    <?php echo $alet->CountAlertExpire(); ?>
                                </span>
                                <div class="<?php echo ($alet->CountAlertExpire() > 0) ? "btn btn-danger" : "btn btn-default"; ?> btn-block">
                        ...
                        <div class="col-md-6 col-lg-6 col-xs-6">
                            <a href="<?php echo Yii::app()->createUrl('backend/stock/expire') ?>">
                                <span class="badge" style=" position: absolute;top:0px; left: 10px; background: <?php echo ($alet->CountExpire() > 0) ? "#000000;" : "#111111;"; ?>">
                                    <?php echo $alet->CountExpire(); ?>
                                </span>
                                <div class="<?php echo ($alet->CountExpire() > 0) ? "btn btn-danger" : "btn btn-default"; ?> btn-block">
                                    <img src="<?php echo Yii::app()->baseUrl; ?>/images/alert-icon.png"
                                         height="48px" /><br/>
                                    สินค้าหมดอายุ
                                </div>
                        ...
                        <div class="col-md-6 col-lg-6 col-xs-6" style=" margin-bottom: 20px;">
                            <a href="<?php echo Yii::app()->createUrl('appoint/appointover') ?>">
                                <span class="badge" style=" position: absolute;top:0px; left: 10px; background: <?php echo ($AppointModel->Countover() > 0) ? "#000000;" : "#111111;"; ?>">
                                    <?php echo $AppointModel->Countover(); ?>
                                </span>
                                <div class="<?php echo ($AppointModel->Countover() > 0) ? "btn btn-danger" : "btn btn-default"; ?> btn-block">
                                    <img src="<?php echo Yii::app()->baseUrl; ?>/images/alert-icon.png" height="48px"/><br/>
                                    นัดลูกค้า
                                </div>
                            </a>
...
<script type="text/javascript">
    ...
    function Setscreen() {
        ...
        if (w > 1024) {
            $("#home-left").css({'height': screenfull, 'overflow': 'auto', 'padding-bottom': '25px', 'border': 'solid #3c4754 0px', 'padding-top': '10px', 'background': '#333333', 'border-radius': '20px 0px 0px 20px'});
            $("#home-right").css({'height': screenfull, 'overflow': 'auto', 'padding-bottom': '25px', 'border': 'solid #3c4754 0px', 'padding-top': '10px', 'background': '#666666', 'border-left': 'none'});
